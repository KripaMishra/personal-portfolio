...
summary: "A single-owner Telegram career agent: submit a job URL and get a private, PII-redacted Markdown fit report saved to Google Sheets."
visibility: public
featured: true
order: 1
lifecycle: in-development
stateSince: 2026-08-10
currentState: The public README documents a bounded /save flow, server-created request context, and owner-scoped persistence. Multi-user and browser-assisted features are explicitly out of scope.
